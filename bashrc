...
# Use all 256 terminal colors with `EXT_COLOR 172`
...
PS1="\n$bldgrn[$txtpur\u$bldgrn@$bldpur\h$bldgrn]$bldpur \w > $bldred\$(parse_git_tag)\$(__git_ps1)\n$bldcyn\\$ "
